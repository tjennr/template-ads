...
- June 20, 2025: Improved text alignment dropdown with visual icons - replaced text labels with Unicode symbols (⚊ Left, ⚌ Center, ⚋ Right, ⚏ Justify) for cleaner visual interface
